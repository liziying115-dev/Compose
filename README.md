[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/UoNVvMad)
...
- Writing sturctured document in Markdown
...
Read through the [tutorial on Markdown](https://www.markdowntutorial.com/)

### Problem-Solving using Python

Imagine you will build a simple music composer using Python. This composer is a Python program that can create simple melodies automatically.
**You are not required to write any code.**
Instead, you’ll brainstorm and document your design ideas in a Markdown file, and practice using Git and GitHub to manage your work.

- Create a local repo and add a `README.md`
